...
struct object *Number_new(struct Number *self)
{
...
int Number_length(struct Number *self)
{
...
struct object *String_new(struct String *self, int size)
{
...
struct object *Symbol_new(struct Symbol *self, struct String *string)
{
...
int Symbol_length(struct Symbol *self)
{
...
struct object *Vector_new(struct Vector *self, int size)
{
...
struct object *Cons_new(struct Cons *self, struct object *car, struct object *cdr)
{
...
int Cons_length(struct Cons *self)
{
  return self->cdr
...
void init2(void)
{
  s_new    = send(symbol, s_intern, "new");
  s_length = send(symbol, s_intern, "length");
